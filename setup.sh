...
if ! type bs58 &>/dev/null; then
  echo "Download bs58: https://github.com/Nullus157/bs58-rs"
...
if ! type nvm &>/dev/null; then
  echo "Download nvm: \`https://github.com/nvm-sh/nvm\`"
  exit 1
...
if ! type rustup &>/dev/null; then
  echo "Download rustup: \`https://rustup.rs/\`"
  exit 1
...
if ! type zoxide &>/dev/null
  if platform_is darwin
    then brew install zoxide
      ...
      echo "Download zoxide: https://github.com/ajeetdsouza/zoxide"
      exit 1
  fi
...
if ! type direnv &>/dev/null
  if platform_is darwin
    then brew install direnv
      ...
      echo "Download direnv: https://github.com/direnv/direnv"
      exit 1
  fi
